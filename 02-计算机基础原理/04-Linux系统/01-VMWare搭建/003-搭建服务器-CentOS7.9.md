...
source: 云的百度网盘 安装资源 > Linux > Kernel
---
...
[vimrc 编辑 CSDN](https://blog.csdn.net/eighters/article/details/137343162)
...
func SetTitle()
    ...
    if &filetype == 'sh'
        ...
        call append(line(".")+1, "\#    Author: yun")
        call append(line(".")+2, "\#    Mail: yuncenliu@163.com ")
